...
const EmployeeDetail = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://transport-management-system-backend.onrender.com/api/user/employee/salary/add", formData, {
        headers: {
  ...
  const retrieveEmployee = async () => {
    const response = await axios.get(
      `https://transport-management-system-backend.onrender.com/api/user/fetch/user-id?userId=${employeeId}`
    );
    return response.data;
  };
  ...
  return (
    <div className="mt-3">
      ...
      <Modal show={showModal} onHide={handleClose} fullscreen>
        ...
        <Modal.Body>
          <iframe
            src={`https://transport-management-system-backend.onrender.com/api/user/document/${employee.uploadDocuments}/view`}
            width="100%"
      ...
      >
        ...
        <Modal.Body>
          <iframe
            src={`https://transport-management-system-backend.onrender.com/api/user/document/${selectedSalaryDoc}/view`}
            width="100%"
            height="100%" // Set height to 100% for full coverage
            style={{ border: "none" }}
            title="Document Preview"
