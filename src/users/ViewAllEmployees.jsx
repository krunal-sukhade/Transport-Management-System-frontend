...
const ViewAllEmployees = () => {
  ...
  const retrieveAllUserByRole = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/user/fetch/employees?role=" +
        role +
        "&status=Active",
      {
        headers: {
  ...
  const retrieveAllUserByName = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/user/fetch/employee-name-wise?name=" + name,
      {
        headers: {
          //   Authorization: "Bearer " + admin_jwtToken, // Replace with your actual JWT token
        },
  ...
  const deleteEmployee = (employeeId, e) => {
    fetch(
      "https://transport-management-system-backend.onrender.com/api/user/employee/delete?employeeId=" + employeeId,
      {
        method: "DELETE",
        headers: {
