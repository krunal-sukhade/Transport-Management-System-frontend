...
const ViewAllClients = () => {
  ...
  const retrieveAllClientsByName = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/transport/client/fetch/name-wise?clientName=" +
        clientName,
      {
        headers: {
          //   Authorization: "Bearer " + admin_jwtToken, // Replace with your actual JWT token
  ...
  const deleteClient = (clientId, e) => {
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/delete?clientId=" + clientId,
      {
        method: "DELETE",
        headers: {
