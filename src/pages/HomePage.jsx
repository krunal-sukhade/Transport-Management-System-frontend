    ...
    <div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="card p-3">
                <p>
                  "This platform has revolutionized how I manage my fleet and
                  employees. Everything's now in one place!"
                </p>
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <p>
                  "Administering the entire transportation business is now
                  easier than ever. Highly recommended!"
                </p>
                <p className="text-end">
            ...
            <div className="col-md-4">
              <div className="card p-3">
                <p>
                  "The secure payment system ensures transparency for both
      ...
      >
        <div className="container text-color">
          <h2>Ready to Manage Your Transport Business?</h2>
          <p className="lead">
            Join many successful admins and transporters who are managing their
