...
const AddClientBooking = () => {
  ...
  const retrieveAllClients = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/transport/client/fetch/all"
    );
    return response.data;
  };
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/user/fetch/employees?role=Driver&status=Active"
    );
    return response.data;
  };
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://transport-management-system-backend.onrender.com/api/transport/client/booking/add", formData)
      .then((resp) => {
