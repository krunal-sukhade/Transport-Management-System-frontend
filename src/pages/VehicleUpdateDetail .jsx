...
const VehicleUpdateDetail = () => {
  ...
  const retrieveVehicle = async () => {
    const response = await axios.get(
      `hhttps://transport-management-system-backend.onrender.com/api/transport/vehicle/fetch?vehicleId=${vehicleId}`
    );
  ...
  const updateVehicle = (e) => {
    ...
    fetch("https://transport-management-system-backend.onrender.com/api/transport/vehicle/detail/udpate", {
      method: "PUT",
      headers: {
