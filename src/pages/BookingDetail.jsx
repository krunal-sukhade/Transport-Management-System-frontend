...
const BookingDetail = () => {
  ...
  const retrieveAllVehicles = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/transport/vehicle/fetch/all",
      {
        headers: {
  ...
  const retrieveAllUser = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/user/fetch/role-wise?role=Employee"
    );
    return response.data;
  };
  ...
  const retrieveBookingDetails = async () => {
    const response = await axios.get(
      `https://transport-management-system-backend.onrender.com/api/transport/client/booking/fetch?bookingId=${bookingId}`
    );
    return response.data;
  };
  ...
  const handleEmployeeAddSubmit = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/employee/add?bookingId=" +
        bookingId +
        "&employeeId=" +
        employeeId,
      {
  ...
  const handleVehicleAddSubmit = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/vehicle/add?bookingId=" +
        bookingId +
        "&vehicleId=" +
        vehicleId,
      {
  ...
  const handleItemFormSubmit = (e) => {
    ...
    fetch("https://transport-management-system-backend.onrender.com/api/transport/client/booking/item/add", {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const handleTripChargesFormSubmit = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/trip/charges/add",
      {
        method: "PUT",
        headers: {
          Accept: "application/json",
  ...
  const handleTripPriceFormSubmit = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/price/detail/add",
      {
        method: "PUT",
        headers: {
          Accept: "application/json",
  ...
  const downloadInvoicePDF = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/generate/invoice?bookingId=" +
        bookingId,
      {
        method: "GET",
        headers: {
