...
const ViewAllVehicles = () => {
  ...
  const retrieveAllVehiclesByNumber = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/transport/vehicle/fetch/vehicle-no-wise?vehicleNo=" +
        vehicleNumber,
      {
        headers: {
          //   Authorization: "Bearer " + admin_jwtToken, // Replace with your actual JWT token
  ...
  const deleteVehicle = (vehicleId, e) => {
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/vehicle/delete?vehicleId=" +
        vehicleId,
      {
        method: "DELETE",
        headers: {
