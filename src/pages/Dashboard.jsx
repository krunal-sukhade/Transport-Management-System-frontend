...
const Dashboard = () => {
  ...
  const retrieveDashboardData = async () => {
    const response = await axios.get(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/admin/dashboard"
    );
  ...
  const getBookingsUsingStartTimeAndEndTime = (e) => {
    ...
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/search/date-time?startTime=" +
  ...
  const getTodaysBookings = (e) => {
    fetch("https://transport-management-system-backend.onrender.com/api/transport/client/booking/todays", {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
  ...
  const markNotificationAsRead = (alertId) => {
    fetch(
      "https://transport-management-system-backend.onrender.com/api/transport/client/booking/dashboard/alert/read?alertId=" +
        alertId,
      {
        method: "GET",
        headers: {
